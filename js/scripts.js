const features = [
  {
    id: 1,
    img: './assets/Home/speaker-01.svg',
    featuredetail: {
      name: 'Yochai Benkler',
  ...
  {
    id: 2,
    img: './assets/Home/speaker-02.svg',
    featuredetail: {
      name: 'SohYeong Noh',
  ...
  {
    id: 3,
    img: './assets/Home/speaker-03.svg',
    featuredetail: {
      name: 'Lila tretikov',
  ...
  {
    id: 4,
    img: './assets/Home/speaker-04.svg',
    featuredetail: {
      name: 'Kilnam Chon',
      positon: '',
  ...
  {
    id: 5,
    img: './assets/Home/speaker-05.svg',
    featuredetail: {
      name: 'Julia Leda',
  ...
  {
    id: 6,
    img: './assets/Home/speaker-06.svg',
    featuredetail: {
      name: 'Ryan Merkley',
...
`;
  ...
  if (displayedFeatures.length === features.length) {
    projectFeatures.innerHTML += '<div class="loadMore" onclick="showMore()" style=""><button>Less<img  src = "./assets/Home/arrow_up_icon.svg"></button></div>';
  } else {
    projectFeatures.innerHTML += '<div class="loadMore" onclick="showMore()" style=""><button>More<img  src = "./assets/Home/arrow_down_icon.svg"></button></div>';
  }
  projectFeatures.appendChild();
}

function popmenu() {
  const mobileMenu = document.querySelector('.showcontent');
